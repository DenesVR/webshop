...
function SaveFormData()
{
    if ( $_SERVER['REQUEST_METHOD'] == "POST" )
    {
        ...
        {
            ValidateUsrPassword( $_POST['cus_wachtwoord'] );
        ...
        foreach ( $_POST as $field => $value )
        {
            ...
            if ( in_array( $field, [ 'btnVerwijderen','btnAnnuleren', 'btnOpslaan', 'formname', 'table', 'pkey', 'afterinsert', 'afterupdate', 'afterdelete', 'csrf' ] ) ) continue;
            ...
            if ( $field == "cus_wachtwoord" ) //encrypt usr_password
            {
